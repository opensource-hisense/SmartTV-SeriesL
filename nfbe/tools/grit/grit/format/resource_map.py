...
#define GRIT_RESOURCE_MAP_EXPORT __attribute__((visibility("default")))
...
extern GRIT_RESOURCE_MAP_EXPORT const GritResourceMap %(map_name)s[];
extern GRIT_RESOURCE_MAP_EXPORT const size_t %(map_name)sSize;
