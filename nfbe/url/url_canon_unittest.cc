...
#if defined(HBBTV_ON)
TEST(URLCanonTest, CanonicalizeDvbURL) {
  struct URLCase {
    const char* input;
    const char* expected;
    bool expected_success;
      ...
      // [.<service_id>[.<component_set>[$<dvb_carousel_id>]]
      // [<dvb_event_constraint>]][<path-absolute>]
      {"dvb://1014.602.621.5/index.html",
       "dvb://1014.602.621.5/index.html",
       true},
      {"dvb://1014.602.621/index.html", "dvb://1014.602.621/index.html", true},
      {"dvb://1014.602/index.html", "dvb://1014.602/index.html", true},
      {"dvb://0123456789.abcdef/index.html",
       "dvb://0123456789.abcdef/index.html",
       true},
      {"dvb://1014.602.621.5", "dvb://1014.602.621.5/", true},

      // Host contains more then 4 components
      {"dvb://1014.602.621.5.6/index.html",
       "dvb://1014.602.621.5.6/index.html",
       false},
      // Host contains less then 2 components
      {"dvb://1014/index.html", "dvb://1014/index.html", false},
      // Empty component is allowed
      {"dvb://1014..602.621/index.html",
       "dvb://1014..602.621/index.html",
       true},
      // Component contains not hex value
      {"dvb://0123456789.abcdefg/index.html",
       "dvb://0123456789.abcdefg/index.html",
       false},

      // dvb://'<textual_service_identifier>'[.<component_set>
      // [$<dvb_carousel_id>]][<dvb_event_constraint>][<path-absolute>]
      {"dvb://current.ait/1.1?param2=value2#foo",
       "dvb://current.ait/1.1?param2=value2#foo",
       true},

      {"dvb://current./1.1?param2=value2#foo",
       "dvb://current./1.1?param2=value2#foo",
       false},
      {"dvb://.ait/1.1?param2=value2#foo",
       "dvb://.ait/1.1?param2=value2#foo",
       false},
      {"dvb://current.aitx/1.1?param2=value2#foo",
       "dvb://current.aitx/1.1?param2=value2#foo",
       false},
  };
  ...
  for (size_t i = 0; i < arraysize(cases); i++) {
    int url_len = static_cast<int>(strlen(cases[i].input));
    Parsed parsed;
    ParseDvbURL(cases[i].input, url_len, &parsed);

    Parsed out_parsed;
    std::string out_str;
    StdStringCanonOutput output(&out_str);
    bool success = CanonicalizeDvbURL(cases[i].input, url_len, parsed, NULL,
                                      &output, &out_parsed);
    output.Complete();
