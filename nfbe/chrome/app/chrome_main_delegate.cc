...
#if defined(CHROME_MULTIPLE_DLL_CHILD) || !defined(CHROME_MULTIPLE_DLL_BROWSER)
  /* ZZZZ: here nacl plugin pepper entry points are registered. */
  /* ZZZZ: see chrome_content_client.cc ChromeContentClient::SetNaClEntryFunctions(). */
#if !defined(DISABLE_NACL)
...
#if defined(ENABLE_PLUGINS)
#if defined(HBBTV_ON)
  ChromeContentClient::SetCBIPEntryFunctions(
      cbip_plugin::PPP_GetInterface,
      cbip_plugin::PPP_InitializeModule,
      cbip_plugin::PPP_ShutdownModule);
#endif
#endif
#endif
}
