...
void ComputeBuiltInPlugins(std::vector<content::PepperPluginInfo>* plugins) {
...
#if defined(HBBTV_ON)
  {
    ...
    cbip.path = base::FilePath::FromUTF8Unsafe(cbip::kInternalCbipPluginFileName);
    cbip.name = cbip::kCbipPluginName;
    content::WebPluginMimeType cbip_js00_mime_type(cbip::kCbipJs00PluginMimeType,
                                                   cbip::kCbipJs00PluginExtension,
                                                   cbip::kCbipJs00PluginDescription);
    cbip.mime_types.push_back(cbip_js00_mime_type);
    content::WebPluginMimeType cbip_js01_mime_type(cbip::kCbipJs01PluginMimeType,
  ...
  }
  {
    ...
    pinfo.path = base::FilePath::FromUTF8Unsafe("/noexist/libdummyoipfvideo.so");
    pinfo.name = "OIPF VIDEO";
    content::WebPluginMimeType mime_type("application/x-oipf-video",
                                         "",
                                         "oipf video plugin");
    pinfo.mime_types.push_back(mime_type);
    content::WebPluginMimeType mime_type2("video/mp4",
                                          "",
                                          "oipf video plugin");
    pinfo.mime_types.push_back(mime_type2);
    pinfo.internal_entry_points.get_interface = fn_oipf_video_get_interface;
    pinfo.internal_entry_points.initialize_module = fn_oipf_video_initialize_module;
...
#if defined(ENABLE_PLUGINS)
#if defined(HBBTV_ON)
void ChromeContentClient::SetCBIPEntryFunctions(
    content::PepperPluginInfo::GetInterfaceFunc get_interface,
    content::PepperPluginInfo::PPP_InitializeModuleFunc initialize_module,
    content::PepperPluginInfo::PPP_ShutdownModuleFunc shutdown_module) {
