...
public final class WebBluetoothError {
    ...
    public static final int GATT_UNKNOWN_ERROR = NO_CHARACTERISTICS_FOUND + 1;
    ...
    public static final int BLACKLISTED_CHARACTERISTIC_UUID = GATT_NOT_AUTHORIZED + 1;

    public static final int BLACKLISTED_READ = BLACKLISTED_CHARACTERISTIC_UUID + 1;

    public static final int BLACKLISTED_WRITE = BLACKLISTED_READ + 1;

    public static final int NOT_ALLOWED_TO_ACCESS_SERVICE = BLACKLISTED_WRITE + 1;

    public static final int REQUEST_DEVICE_WITH_BLACKLISTED_UUID = NOT_ALLOWED_TO_ACCESS_SERVICE + 1;

    public static final int REQUEST_DEVICE_FROM_CROSS_ORIGIN_IFRAME = REQUEST_DEVICE_WITH_BLACKLISTED_UUID + 1;

    public static final int REQUEST_DEVICE_WITHOUT_FRAME = REQUEST_DEVICE_FROM_CROSS_ORIGIN_IFRAME + 1;

    public static final int ENUM_MAX_VALUE = (int) (WebBluetoothError.REQUEST_DEVICE_WITHOUT_FRAME);
