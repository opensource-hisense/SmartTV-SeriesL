...
{this.tree=this;this.children=[];this._formatter=formatter;this._searchableView=searchableView;this.totalTime=totalTime;this.lastComparator=null;this.childrenByCallUID={};}
...
{WebInspector.ProfileDataGridTree.call(this,formatter,searchableView,totalTime);this._remainingChildren=rootProfileNode.children;WebInspector.ProfileDataGridNode.populate(this);}
...
this._bottomUpProfileDataGridTree=new WebInspector.BottomUpProfileDataGridTree(this._nodeFormatter,this._searchableView,(this.profile.profileHead),this.totalCpuTime);return this._bottomUpProfileDataGridTree;},_getTopDownProfileDataGridTree:function()
{if(!this._topDownProfileDataGridTree)
this._topDownProfileDataGridTree=new WebInspector.TopDownProfileDataGridTree(this._nodeFormatter,this._searchableView,(this.profile.profileHead),this.totalCpuTime);return this._topDownProfileDataGridTree;},willHide:function()
...
{this._searchableElement.jumpToPreviousSearchResult();},_ensureFlameChartCreated:function()
{if(this._flameChart)
...
var isFlame=this._viewType.get()===WebInspector.CPUProfileView._TypeFlame;this.focusButton.setVisible(!isFlame);this.excludeButton.setVisible(!isFlame);this.resetButton.setVisible(!isFlame);this._visibleView.show(this._searchableView.element);},_nodeSelected:function(selected)
...
{var callFrame=(node.profileNode);return this._profileView._linkifier.linkifyConsoleCallFrame(this._profileView.target(),callFrame,"profile-node-file");}};WebInspector.HeapSnapshotProgressEvent={Update:"ProgressUpdate",BrokenSnapshot:"BrokenSnapshot"};WebInspector.HeapSnapshotCommon={}
...
{this._eventHandler=eventHandler;this._nextObjectId=1;this._nextCallId=1;this._callbacks=new Map();this._previousCallbacks=new Set();this._worker=new WorkerRuntime.Worker("heap_snapshot_worker");this._worker.onmessage=this._messageReceived.bind(this);}
