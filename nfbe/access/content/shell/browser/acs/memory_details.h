...
#ifndef CONTENT_SHELL_BROWSER_ACS_MEMORY_DETAILS_H_
#define CONTENT_SHELL_BROWSER_ACS_MEMORY_DETAILS_H_
...
struct ProcessMemoryInformation {
  ...
  // The CPU Usage for this process - currently NOT WORKING
  double cpu_usage;
};
...
#endif  // CONTENT_SHELL_BROWSER_ACS_MEMORY_DETAILS_H_
