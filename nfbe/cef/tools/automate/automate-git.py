...
cef_git_url = 'git@gitlab.com:access_company/NFBE2CEF.git'
...
# ASE: the branches for ASE can have also names like prv_xxx
#if cef_branch != 'trunk' and int(cef_branch) <= 1453:
#  print 'The requested branch is too old to build using this tool'
#  sys.exit()

# ASE: basically we are using always newer versions of CEF than 43.0
if cef_branch != 'trunk' and not cef_branch[0].isdigit():
  branch_is_2272_or_newer = True
else:
