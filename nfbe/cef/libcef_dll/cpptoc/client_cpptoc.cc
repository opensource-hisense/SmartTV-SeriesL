...
cef_hbbtvapp_mgr_ptr_t CEF_CALLBACK client_get_hbbtvapp_mgr(
    struct _cef_client_t* self) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  cef_hbbtvapp_mgr_ptr_t _retval = CefClientCppToC::Get(self)->GetHBBTVAppMgr();
...
CefClientCppToC::CefClientCppToC() {
  ...
  GetStruct()->get_hbbtvapp_mgr = client_get_hbbtvapp_mgr;
}
