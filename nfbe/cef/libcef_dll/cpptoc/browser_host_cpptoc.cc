...
CEF_EXPORT cef_hbbtvbrowser_ptr_t cef_browser_host_create_new_browser_window(
  ...
  // Execute
  cef_hbbtvbrowser_ptr_t _retval = CefBrowserHost::CreateNewBrowserWindow(
      CefString(url));
...
cef_hbbtvweb_contents_ptr_t CEF_CALLBACK browser_host_get_web_contents(
    struct _cef_browser_host_t* self) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  cef_hbbtvweb_contents_ptr_t _retval = CefBrowserHostCppToC::Get(
      self)->GetWebContents();
...
void CEF_CALLBACK browser_host_load_urlno_focus(
    struct _cef_browser_host_t* self, const cef_string_t* url,
    const int focused) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  CefBrowserHostCppToC::Get(self)->LoadURLNoFocus(
      CefString(url),
      focused?true:false);
}
...
CefBrowserHostCppToC::CefBrowserHostCppToC() {
  ...
  GetStruct()->get_web_contents = browser_host_get_web_contents;
  GetStruct()->load_urlno_focus = browser_host_load_urlno_focus;
