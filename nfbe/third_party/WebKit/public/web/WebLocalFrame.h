...
#if defined(HBBTV_ON)
    // This api create a Document for the passed xml string and returns
    // v8 object of Document Type.
    virtual v8::Local<v8::Object> createAndGetDocumentV8Object(
        const WebString& xml_capabilities) = 0;
#endif
