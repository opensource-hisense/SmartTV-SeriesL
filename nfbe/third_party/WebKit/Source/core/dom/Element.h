...
#if defined(HBBTV_ON)
    void setPreventsDefaultSetter(bool prevents) { m_preventsDefaultSetter = prevents; }
    bool preventsDefaultSetter() { return m_preventsDefaultSetter; }
#endif
