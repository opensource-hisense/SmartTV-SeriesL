...
public:
    ...
    bool needsWidgetUpdateBecauseOfPluginRedetermination() const { return m_needsWidgetUpdateBecauseOfPluginRedetermination; }
    void setNeedsWidgetUpdateBecauseOfPluginRedetermination(bool needsWidgetUpdateBecauseOfPluginRedetermination) { m_needsWidgetUpdateBecauseOfPluginRedetermination = needsWidgetUpdateBecauseOfPluginRedetermination; }
#endif
    void updateWidget();
...
#if defined(HBBTV_ON)
    // FIXME: this logic needs fix once Google fix this problem in M49 or later.
    bool m_needsWidgetUpdateBecauseOfPluginRedetermination;
#endif
