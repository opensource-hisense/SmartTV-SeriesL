...
// need to export visibility of static function
#include "third_party/hunspell/src/hunspell/hunvisapi.h"
...
class BDict {
 public:
  ...
  LIBHUNSPELL_DLL_EXPORTED static bool Verify(const char* bdict_data,
                                              size_t bdict_length);
};
