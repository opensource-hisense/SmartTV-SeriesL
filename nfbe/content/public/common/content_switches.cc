...
// Enables the auto-test feature, which triggers the browser to load links from
// the 'sitelist.txt' file every 10 seconds - by default it loads all links once.
// The parameter specifies how many times should the browser load all the links.
const char kAcsAutoTest[]   = "acs-autotest";
...
// Launches PerformanceMonitorLight at startup, which will gather statistics
// about content_shell's CPU and memory usage
...
const char kPerformanceMonitorLight[]       = "performance-monitor-light";
...
// [ACS] enable or disable automatic scaling: "enable" or "disable".
const char kAcsEnableAutomaticScaling[]     = "acs-enable-automatic-scaling";
#endif
