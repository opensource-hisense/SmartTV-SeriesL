...
CONTENT_EXPORT extern const char kAcsAutoTest[];
...
CONTENT_EXPORT extern const char kPerformanceMonitorLight[];
...
CONTENT_EXPORT extern const char kAcsEnableAutomaticScaling[];
#endif
