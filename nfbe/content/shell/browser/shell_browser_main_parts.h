...
#if defined(HBBTV_ON)
  hbbtv::HBBTVAppMgr* hbbtv_app_mgr() { return hbbtv_app_mgr_.get();}
#endif
 protected:
...
#if defined(HBBTV_ON)
  scoped_ptr<hbbtv::HbbTVBrowserWindowFactory> window_factory_;
  scoped_ptr<hbbtv::HBBTVAppMgr> hbbtv_app_mgr_;
#endif
