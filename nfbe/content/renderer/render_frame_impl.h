...
#if defined(HBBTV_ON)
  void didFinishLoadingXMLAIT(const blink::WebXMLAIT& webxmlait) override;
#endif
...
#if defined(HBBTV_ON)
  blink::WebChannelList* createChannelList() override;
#endif
...
#if defined(HBBTV_ON)
  // This api is a wrapper for OnSwapOut and only used by
  // unittest implemented for hbbtv developement
  void OnSwapOutWrapper(int proxy_routing_id,
                        bool is_loading,
                        const FrameReplicationState& replicated_frame_state);
  v8::Local<v8::Object> CreateAndGetDocumentV8Object(
