...
#if defined(HBBTV_ON)
#include "access/content/renderer/oipf/web_channel_list_impl.h"
#endif
...
#if defined(HBBTV_ON)
#include "third_party/WebKit/public/platform/WebXMLAIT.h"
#endif
...
#if defined(HBBTV_ON)
void RenderFrameImpl::OnSwapOutWrapper(
    int proxy_routing_id,
    bool is_loading,
...
v8::Local<v8::Object> RenderFrameImpl::CreateAndGetDocumentV8Object(
    const std::string& xml_capabilities) {
  WebString xml = WebString::fromUTF8(xml_capabilities);
  return frame_->createAndGetDocumentV8Object(xml);
}
#endif
...
#if defined(HBBTV_ON)
  OipfHbbtvKeyEventSupport::Install(frame);
#endif
...
#if defined(HBBTV_ON)
void RenderFrameImpl::didFinishLoadingXMLAIT(const WebXMLAIT& webxmlait) {
    TRACE_EVENT1("navigation", "RenderFrameImpl::didFinishLoadingXMLAIT",
                 "appID", webxmlait.m_aitAppID);
    FrameHostMsg_DidFinishLoadXMLAIT_Params params;
    params.appID = webxmlait.m_aitAppID;
    params.applicationLocation = webxmlait.m_aitApplicationLocation.utf8();
    params.controlCode = webxmlait.m_aitControlCode.utf8();
    params.orgID = webxmlait.m_aitOrgID;
    params.priority = webxmlait.m_aitPriority;
    params.serviceBound = webxmlait.m_aitServiceBound;
    GURL baseurl(webxmlait.m_aitUrlBase.utf8());
    params.urlBase = baseurl;
    params.visibility = webxmlait.m_aitVisibility.utf8();
    Send(new FrameHostMsg_DidFinishLoadXMLAIT(routing_id_, params));
}
#endif
...
#if defined(HBBTV_ON)
blink::WebChannelList* RenderFrameImpl::createChannelList() {
  return new WebChannelListImpl(routing_id_);
}
#endif
