...
#if defined(HBBTV_ON)
  void SetHbbTVDelegate(WebContentsHbbTVDelegate*) override;
#endif
...
#if defined(HBBTV_ON)
  void OnDidFinishLoadXMLAIT(const FrameHostMsg_DidFinishLoadXMLAIT_Params& params);
#endif
...
#if defined(HBBTV_ON)
  WebContentsHbbTVDelegate* hbbtv_delegate_;
#endif
