...
#if 0
  // To be activated if defined(HBBTV_ON)
  // This shouldn't be a problem any more if the insert map operation is used.
  // This is a workaround for a webmediaplayer_impl.cc bug 
  // which triggers DidPlay() twice.
  if (std::find((*player_map)[id.first].begin(),
