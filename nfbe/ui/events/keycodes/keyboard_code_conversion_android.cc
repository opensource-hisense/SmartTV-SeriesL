...
#if defined(HBBTV_KEY_EVENT_TEST)
...
DomKey GetDomKeyFromAndroidKeycode(int keycode) {
  switch (keycode) {
    ...
    case AKEYCODE_F8:
      return DomKey::F8;
    case AKEYCODE_F9:
#if defined(HBBTV_ON) && defined(HBBTV_KEY_EVENT_TEST)
      return DomKey::CEA_BACK; // the third back button.
#else
      return DomKey::F9;
#endif
    case AKEYCODE_F10:
...
KeyboardCode KeyboardCodeFromAndroidKeyCode(int keycode) {
#if defined(HBBTV_KEY_EVENT_TEST)
  LOG(INFO)<<"KeyboardCodeFromAndroidKeyCode: "<<keycode;
#endif
  ...
  switch (keycode) {
    ...
    case AKEYCODE_F9:
#if defined(HBBTV_ON) && defined(HBBTV_KEY_EVENT_TEST)
      return CEA_VK_BACK; // the third back button.
#else
      return VKEY_F9;
#endif
    case AKEYCODE_F10:
    ...
    case AKEYCODE_PROG_GREEN:
      return CEA_VK_GREEN;
    case AKEYCODE_PROG_YELLOW:
      return CEA_VK_YELLOW;
    case AKEYCODE_PROG_BLUE:
      return CEA_VK_BLUE;
    case AKEYCODE_MEDIA_RECORD:
      return CEA_VK_RECORD;
    case AKEYCODE_TV_TELETEXT:
      return CEA_VK_TELETEXT;
#endif
    default:
      return VKEY_UNKNOWN;
  }
