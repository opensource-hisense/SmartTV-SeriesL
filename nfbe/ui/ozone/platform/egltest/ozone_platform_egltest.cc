...
const char kEglplatformShimDefault[] = "libeglplatform_shim.so.3";
const char kDefaultEglSoname[] = "libEGL.so";
const char kDefaultGlesSoname[] = "libGLESv2.so";
#else
...
#if defined(HBBTV_ON)
        // Alpha is needed to show broadcast video.
        EGL_ALPHA_SIZE, 8,
#endif
        EGL_NONE,
    };
