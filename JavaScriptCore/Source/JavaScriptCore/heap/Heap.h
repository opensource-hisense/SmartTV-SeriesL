...
namespace JSC {
    ...
    public:
        ...
        enum GCPhase { GCPhase_StartMark, GCPhase_EndMark, GCPhase_StartSweep, GCPhase_EndSweep };
        typedef void (*GCPhaseCallback)(int);
        static void setCallback(GCPhaseCallback);
#endif

        static void setMaxBytesPerCycle(size_t maxBytesPerCycle);
