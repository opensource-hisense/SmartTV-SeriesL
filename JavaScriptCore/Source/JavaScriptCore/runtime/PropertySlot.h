...
#define INDEX_GETTER_MARKER reinterpret_cast<JSC::PropertySlot::GetValueFunc>(2)
#define GETTER_FUNCTION_MARKER reinterpret_cast<JSC::PropertySlot::GetValueFunc>(3)
    ...
    public:
        ...
        JSObject *getterFunc() const { return m_data.getterFunc; }
