...
namespace JSC {
    ...
    public:
        PostfixErrorNode(const JSTokenLocation&, ExpressionNode*, Operator, unsigned divot, unsigned startOffset, unsigned endOffset);
    ...
    public:
        PrefixErrorNode(const JSTokenLocation&, ExpressionNode*, Operator, unsigned divot, unsigned startOffset, unsigned endOffset);
    ...
    public:
        AssignResolveNode(const JSTokenLocation&, const Identifier&, ExpressionNode* right, bool rightHasAssignments);
    ...
    public:
        AssignErrorNode(const JSTokenLocation&, ExpressionNode* left, Operator, ExpressionNode* right, unsigned divot, unsigned startOffset, unsigned endOffset);
    ...
    public:
        ForNode(const JSTokenLocation&, ExpressionNode* expr1, ExpressionNode* expr2, ExpressionNode* expr3, StatementNode*, bool expr1WasVarDecl);
    ...
    public:
        ForInNode(JSGlobalData*, const JSTokenLocation&, ExpressionNode*, ExpressionNode*, StatementNode*);
