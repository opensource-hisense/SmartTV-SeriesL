...
StringImpl::RefCallback StringImpl::sRefCallback = 0;
StringImpl::DerefCallback StringImpl::sDerefCallback = 0;
#endif
...
size_t StringImpl::reverseFindLineTerminator(unsigned index) const
{
    if (is8Bit())
