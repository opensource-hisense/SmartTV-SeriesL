...
// HACK: X360 workaround for global dtor crash due to out of order
//       dll unloading caused by unavoidable cyclic dll dependency
#if defined(_XBOX_VER) 
extern bool _isDllExit;
#endif
