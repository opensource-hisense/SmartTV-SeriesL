 ...
 * Original file in Diag: umc_es2_real_ch0-2x2_ch1-4x1_ch2-2x1_SCrefES1board_1600mhz.S
 */
...
int umc_init_sub(void)
{
	...
	/* b0=static mode 0 */
	writel(0x00000408, 0x5bc04008);	/* ch0_A */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5bc04100);	/* ch0_A */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5bc05008);	/* ch0_B */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5bc05100);	/* ch0_B */
	...
	writel(0x00000080, 0x5bc040c0);	/* ch0_A */
	...
	writel(0x00000080, 0x5bc041b8);	/* ch0_A */
	/* DQA0/DQA1 レシーバ制御 [15]:[7]レシーバ切り替え信号 (1:低電力 0:default)  */
	...
	/* DQSA  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5bc050c0);	/* ch0_B */
	/* DQB0/DQB1 レシーバ制御 [15]:[7]レシーバ切り替え信号 (1:低電力 0:default)  */
	...
	/* DQSB  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5bc051b8);	/* ch0_B */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5bc040D0);	/* ch0_A */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5bc041C8);	/* ch0_A */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5bc050D0);	/* ch0_B */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5bc051C8);	/* ch0_B */
	/* DRVEN信号(DIO内部信号)EN区間調整 */
	...
	/* b0=static mode 0 */
	writel(0x00000408, 0x5be04008);	/* ch1_A */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5be04100);	/* ch1_A */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5be05008);	/* ch1_B */
	/* b0=static mode 0 */
	writel(0x00000408, 0x5be05100);	/* ch1_B */
	/* ODTEN信号(DIO内部信号)EN区間調整 */
	...
	/* DQSA  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5be040c0);	/* ch1_A */
	/* DQB0/DQB1 レシーバ制御 [15]:[7]レシーバ切り替え信号 (1:低電力 0:default)  */
	...
	/* DQSB  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5be041b8);	/* ch1_A */
	/* DQA0/DQA1 レシーバ制御 [15]:[7]レシーバ切り替え信号 (1:低電力 0:default)  */
	...
	/* DQSA  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5be050c0);	/* ch1_B */
	/* DQB0/DQB1 レシーバ制御 [15]:[7]レシーバ切り替え信号 (1:低電力 0:default)  */
	...
	/* DQSB  レシーバ制御 [7]レシーバ切り替え信号 (1:低電力 0:default)  */
	writel(0x00000080, 0x5be051b8);	/* ch1_B */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5be040D0);	/* ch1_A */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5be041C8);	/* ch1_A */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5be050D0);	/* ch1_B */
	/* [1]Writeクロックゲーティング制御信号(1：ゲーティング（低消費電力))、[0]遅延線の折り返しゲーティング制御信号(0：ゲーティング（低消費電力)) */
	writel(0x00000002, 0x5be051C8);	/* ch1_B */
	/* D0A_B D1A_B  Toffset設定値 */
	writel(0x00002222, 0x5bc01440);	/* ch0 */
	/* D0A_B D1A_B  Roffset設定値 */
	writel(0x00002320, 0x5bc01444);	/* ch0 */
	/* D0B WriteLeveling設定値 */
	writel(0x00000024, 0x5bc01200);	/* ch0 */
	/* D0A WriteLeveling設定値 */
	writel(0x00000024, 0x5bc01204);	/* ch0 */
	/* D1B WriteLeveling設定値 */
	writel(0x0000001d, 0x5bc01260);	/* ch0 */
	/* D1A WriteLeveling設定値 */
	writel(0x0000001d, 0x5bc01264);	/* ch0 */
	/* D0A  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5bc01244);	/* ch0 */
	/* D0B  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5bc01240);	/* ch0 */
	/* D1A  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5bc012A4);	/* ch0 */
	/* D1B  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5bc012A0);	/* ch0 */
	/* D0A_B D1A_B  Toffset設定値 */
	writel(0x00002222, 0x5be01440);	/* ch1 */
	/* D0A_B D1A_B  Roffset設定値 */
	writel(0x00002320, 0x5be01444);	/* ch1 */
	/* D0B WriteLeveling設定値 */
	writel(0x0000001f, 0x5be01200);	/* ch1 */
	/* D0A WriteLeveling設定値 */
	writel(0x00000033, 0x5be01204);	/* ch1 */
	/* D1B WriteLeveling設定値 */
	writel(0x00000026, 0x5be01260);	/* ch1 */
	/* D1A WriteLeveling設定値 */
	writel(0x00000026, 0x5be01264);	/* ch1 */
	/* D0A  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5be01244);	/* ch1 */
	/* D0B  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5be01240);	/* ch1 */
	/* D1A  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5be012A4);	/* ch1 */
	/* D1B  DQSEN用遅延線角度情報 */
	writel(0x00000000, 0x5be012A0);	/* ch1 */
	/* DLL更新遅延設定 */
	writel(0x00000f0f, 0x5bc01608);	/* ch0 */
	/* CK　　角度情報  */
	writel(0x0000000a, 0x5bc01370);	/* ch0 */
	/* DLL更新遅延設定 */
	writel(0x00000f0f, 0x5be01608);	/* ch1 */
	/* CK　　角度情報  */
	writel(0x00000006, 0x5be01370);	/* ch1 */
	/* Update Force */
	...
	/* DRAM初期化MR0設定レジスタ */
	writel(0x00000D71, 0x5bc0001c);	/* UMCDrmMR0 : ch0 */
	writel(0x00000D71, 0x5be0001c);	/* ch1 */
	writel(0x00000D71, 0x5dc0001c);	/* ch2 */
	/* DRAM初期化MR1設定レジスタ */
	writel(0x00000006, 0x5bc00020);	/* UMCDrmMR1 : ch0 */
	writel(0x00000006, 0x5be00020);	/* ch1 */
	writel(0x00000006, 0x5dc00020);	/* ch2 */
	/* DRAM初期化MR2設定レジスタ */
	writel(0x00000218, 0x5bc00024);	/* UMCDrmMR2 : ch0 */
	writel(0x00000218, 0x5be00024);	/* ch1 */
	writel(0x00000218, 0x5dc00024);	/* ch2 */
	/* DRAM初期化MR3設定レジスタ */
	...
	writel(0x003F0617, 0x5bc00030);	/* UMCSpcCtlA : ch0 */
	writel(0x003F0617, 0x5be00030);	/* ch1 */
	writel(0x003F0617, 0x5dc00030);	/* ch2 */
	/* DRAM特殊コマンド間隔設定レジスタB */
	...
	writel(0x001b001b, 0x5bc00600);	/* UMCRDATACTL_D0 : ch0 */
	writel(0x001b001b, 0x5bc00608);	/* UMCRDATACTL_D1 : ch0 */
	writel(0x001b001b, 0x5be00600);	/* UMCRDATACTL_D0 : ch1 */
	writel(0x001b001b, 0x5dc00600);	/* UMCRDATACTL_D0 : ch2 */
	writel(0x03062907, 0x5bc00604);	/* UMCWDATACTL_D0 : ch0 */
	writel(0x03062907, 0x5bc0060c);	/* UMCWDATACTL_D1 : ch0 */
	writel(0x03062907, 0x5be00604);	/* UMCWDATACTL_D0 : ch1 */
	writel(0x03062907, 0x5dc00604);	/* UMCWDATACTL_D0 : ch2 */
	...
	/* ch0 Write Dataアサートタイミング調整 */
	writel(0x0003C000, 0x5dc00348);	/* UMCANACTLC : ch2 */
